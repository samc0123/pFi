...
def transaction_knn_model(training_dataset:pd.DataFrame,actual_dataset:pd.DataFrame) :
    ...
    df_predictedCategories.to_csv(path_or_buf='/Users/samchernov/Desktop/Personal/Financials/Transaction_Export/pFi/knnPredictions.csv')
